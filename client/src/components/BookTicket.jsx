  ...
  return (
    <div className=" min-h-screen bg-gray-100">
      <div className='w-full flex justify-between '>
        ...
        <div className=''>
         {showHam?
         <TicketList showHam={showHam} setShowHam={setShowHam} />:
         <RxHamburgerMenu onClick={()=>setShowHam(!showHam)}
        ...
        <div className='flex flex-row justify-center items-center'>
          {/* -----------------------verfiy--Ticket----------------------------------- */}
           ...
           <button className='bg-green-500 py-2 px-4 m-4 text-white rounded-md shadow-lg'>Verify Ticket</button>
           </Link>
           <Logout />
      ...
      <div className="bg-white shadow-md rounded-lg p-6 w-96">
        ...
        <div>
          <button
            onClick={buyTicket}
            disabled={price === null}
            className={`my-2 w-full p-2 rounded-md text-white ${price !== null ? 'bg-blue-500 hover:bg-blue-600' : 'bg-gray-400 cursor-not-allowed'}`}
          >
            Buy Ticket
          </button>
        </div>
